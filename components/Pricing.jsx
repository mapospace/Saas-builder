            ...
            <div id="pricing">
                <div className='container'>
                    <div className='max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
                        ...
                        <div className='relative z-4 mx-auto mb-36 flex w-[375px] rounded-3xl border-[3px] border-s4/25 bg-s1/50 p-2 backdrop-blur-[6px] max-md:w-[310px]'>
                        ...
                        <div className='scroll-hide -mt-12 relative z-5 flex items-start max-xl:gap-5 max-xl:overflow-x-scroll max-xl:overflow-y-hidden max-xl:pt-6 '>
                            {plans.map((plan, index) => (<div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2  p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                                {index === 1 && (
                                ...
                                <div className={clsx('relative flex flex-col items-center', index === 1 ? 'pt-24' : 'pt-12')}>
                                    ...
                                    <div className='relative z-2 flex items-center justify-center'>
                                        ...
                                        <div className='small-1 relative top-3 ml-1'> /mo
                                        </div>
                                    </div>
                                </div>

                                <div className={clsx('body-1 relative z-2 mb-10 w-full bordeer-b-s2 pb-9 text-center text-p4 ', index === 1 && "border-b border-s5")}>{plan.caption}
                                </div>
