...
const NavLink = ({ title }) => (
    <Link href="#" className='base-bold text-p4 uppercase transition-colors duration-500 cursor-pointer hover:text-p1 max-lg:my-4 max-lg:h5'>{title}</Link>
)
const Header = () => {
    ...
    return (
        <header className={clsx('fixed left-0 top-0 z-50 w-full py-10 transition-all duration-500 max-lg:py-4', hasScrolled && 'py-4 bg-black-100 backdrop-blur-[8px]')}>
                        ...
                        <nav className='max-lg:relative max-lg:z-2 max-lg:my-auto'>
                            <ul className='flex max-lg:block max-lg:px-12'>
                                ...
                                <li className='nav-logo'>
                                    <Link href="#" className={clsx("max-lg:hidden transition-transform duration-500 cursor-pointer")}>
